...
<div class="container">
        <div class="row">
            <div class="col-md-6 ml-auto">
                <img src="img/neon/neon.png" id="img-fluid" alt="Imagen" class="img-fluid animate__animated animate__fadeInLeft" style="animation-duration: 1s;">
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-12 col-lg-10 col-sm-wrap text-center">
                <button onclick="playVideo('videoneon1')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.2s;">
                    <img class="mi-imagen" src="img/neon/Q.png">
                </button>
                <button onclick="playVideo('videoneon2')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.4s;">
                    <img class="mi-imagen" src="img/neon/E.png" alt="">
                </button>
                <button onclick="playVideo('videoneon3')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.6s;">
                    <img class="mi-imagen" src="img/neon/C.png" alt="">
                </button>
                <button onclick="playVideo('videoneon4')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.8s;">
