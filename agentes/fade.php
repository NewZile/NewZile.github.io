...
<div class="container">
    <div class="row">
        <div class="col-md-6 ml-auto">
            <img src="img/fade/fade.png" id="img-fluid" alt="Imagen" class="img-fluid animate__animated animate__fadeInLeft" style="animation-duration: 1s;">
        </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-sm-12 col-lg-10 col-sm-wrap text-center">
            <button onclick="playVideo('videofade1')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.2s;">
                <img class="mi-imagen" src="img/fade/Q.png">
            </button>
            <button onclick="playVideo('videofade2')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.4s;">
                <img class="mi-imagen" src="img/fade/E.png" alt="">
            </button>
            <button onclick="playVideo('videofade3')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.6s;">
                <img class="mi-imagen" src="img/fade/C.png" alt="">
            </button>
            <button onclick="playVideo('videofade4')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.8s;">
                <img class="mi-imagen" src="img/fade/X.png" alt="">
            </button>
        </div>
    </div>
</div>
