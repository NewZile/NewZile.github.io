...
<div class="container">
        <div class="row">
            <div class="col-md-6 ml-auto">
                <img src="img/jett/jett.png" id="img-fluid" alt="Imagen" class="img-fluid animate__animated animate__fadeInLeft" style="animation-duration: 1s;">
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-12 col-lg-10 col-sm-wrap text-center">
                <button onclick="playVideo('videojett1')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.2s;">
                    <img class="mi-imagen" src="img/jett/Q.png">
                </button>
                <button onclick="playVideo('videojett2')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.4s;">
                    <img class="mi-imagen" src="img/jett/E.png" alt="">
                </button>
                <button onclick="playVideo('videojett3')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.6s;">
                    <img class="mi-imagen" src="img/jett/C.png" alt="">
                </button>
                <button onclick="playVideo('videojett4')" class="animate__animated animate__bounceIn" style="animation-duration: 1s; animation-delay: 0.8s;">
                    <img class="mi-imagen" src="img/jett/X.png" alt="">
                </button>
            </div>
        </div>
    </div>
