...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="menu">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="admin/administracion.php">Administración</a>
        </li>
        <li class="nav-item">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"
    ...
    <img src="img/personajes/gekko.png" alt="" class="image">
    <div class="text_container"></div>
    <div class="logo">
      <img src="img/fondo/logo.png" alt="">
    </div>
    <div class="main_text">
      <p>Para más información visite la siguiente imagen</p>
    </div>
    <div class="date">
      <p>7.03.2023</p>
    </div>
    <div class="card_btn">
      <a href="agentes/gekko.php?id=1">Más Información</a>
    </div>
  </div>
  ...
  <div class="first card">
    ...
    <div class="card_btn">
      <a href="agentes/jett.php?id=3">Mas Información</a>
    </div>
  </div>
  ...
  <div class="second card">
    ...
    <div class="card_btn">
      <a href="agentes/reyna.php?id=2">Mas Información</a>
    </div>
  </div>
  <div class="first card">
    ...
    <div class="card_btn">
      <a href="agentes/phoenix.php?id=4">Mas Información</a>
    </div>
  </div>
  <div class="first card">
    ...
    <div class="card_btn">
      <a href="agentes/yoru.php?id=5">Mas Información</a>
    </div>
  </div>
  <div class="second card">
    ...
    <div class="card_btn">
      <a href="agentes/neon.php?id=6">Mas Información</a>
    </div>
  </div>
  <div class="first card">
    ...
    <div class="card_btn">
      <a href="agentes/fade.php?id=7">Mas Información</a>
    </div>
  </div>
